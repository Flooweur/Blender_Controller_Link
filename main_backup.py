...
class SDL2_Controller_Handler:
    ...
    def poll(self):
        ...
        cle_reader.location = cle_reader.location
...
class CLE_OT_LiveControllerInputs(bpy.types.Operator):
    ...
    def modal(self, context, event):
        if event.type == 'TIMER':
            CLE_OT_LiveControllerInputs.sdl2_controller_handler.poll()
    ...
    def execute(self, context):
        ...
        CLE_OT_LiveControllerInputs.sdl2_controller_handler = SDL2_Controller_Handler()
...
class CLE_OT_RecordControllerInputs(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        CLE_OT_RecordControllerInputs.sdl2_controller_handler = SDL2_Controller_Handler()
