...
def register():
    ...
    # Available inputs for prop_search (temporary)
    bpy.types.Scene.cle_available_inputs = bpy.props.CollectionProperty(
        name="Available Inputs",
        description="Temporary collection for input selection"
    )
